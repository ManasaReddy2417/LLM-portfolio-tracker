...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  /* ── Base ── */
  body{font-family:'Inter','Segoe UI',sans-serif;background:linear-gradient(135deg,#6366f1 0%,#818cf8 30%,#a78bfa 60%,#7c3aed 100%);min-height:100vh;padding:24px 40px;}
  .container{max-width:1400px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 8px 40px rgba(99,102,241,.3);}
  ...
  /* ── Card inner table scroll wrapper ── */
  .card-table-scroll{overflow-x:auto;-webkit-overflow-scrolling:touch;width:100%;}

  /* ── Tables ── */
  table{width:100%;border-collapse:collapse;}
  .tbl-head-row th{background:linear-gradient(135deg,#3b3f9e,#6c40c9);color:#fff;padding:10px 7px;font-size:.72em;font-weight:800;text-transform:uppercase;letter-spacing:.7px;text-align:center;border-right:1px solid rgba(255,255,255,0.15);white-space:nowrap;}
  .tbl-sub-row th{background:linear-gradient(90deg,#4f52b8,#7c4dcf);color:#fff;padding:7px 6px;font-size:.68em;font-weight:700;text-transform:uppercase;letter-spacing:.5px;text-align:center;border-bottom:3px solid rgba(255,255,255,0.3);border-right:1px solid rgba(255,255,255,0.15);}
  tbody tr:nth-child(even){background:#f5f6ff;}
  tbody tr:hover{background:#eef0ff;}
  tbody tr{border-bottom:1px solid #e8eaf6;}
  td{padding:7px 7px;font-size:0.78em;text-align:center;color:#374151;border-right:1px solid #ececf8;}
  .stock-col{text-align:left!important;font-weight:800;color:#1e3a8a;padding-left:12px!important;font-size:0.82em;}
  ...
  .price-table-wrap table thead th{background:#1e3a8a;color:#fff;padding:7px 4px;font-size:.60em;font-weight:700;text-transform:uppercase;letter-spacing:.4px;text-align:center;white-space:nowrap;}
  .price-table-wrap table tbody td{font-size:.68em;padding:5px 4px;}
  ...
  @media(max-width:600px){
    ...
    /* Chart: shorter height on mobile */
    #line-chart .js-plotly-plot,.plotly,.plot-container{min-height:280px!important;}

    /* Bar chart: 2 columns on mobile */
    ...
    /* Tables */
    td{padding:5px 4px;font-size:.72em;}
    .stock-col{font-size:.75em;padding-left:8px!important;}
    .tbl-head-row th{font-size:.62em;padding:8px 4px;}
    .tbl-sub-row th{font-size:.6em;padding:6px 4px;}
    .price-section{padding:14px 10px;}
    .price-table-wrap table tbody td{font-size:.62em;padding:4px 3px;}
    .price-table-wrap table thead th{font-size:.56em;padding:6px 3px;}
  }
</style>
</head>
<body>
...
Plotly.newPlot('line-chart', lineTraces, {{
  ...
  xaxis: {{
    title: {{ text: 'Date', font: {{ size: 13, color: '#374151', family: 'Inter,sans-serif' }} }},
    showgrid: true, gridcolor: '#e8ecf4', gridwidth: 1,
    color: '#374151',
    tickfont: {{ size: 11, color: '#374151', family: 'Inter,sans-serif' }},
    zeroline: false, showline: true, linecolor: '#cbd5e1', tickcolor: '#94a3b8',
    automargin: true, tickangle: -45,
    range: [-0.8, dates.length - 0.8]
  }},
  yaxis: {{
    title: {{ text: 'Portfolio Value ($)', font: {{ size: 13, color: '#1e3a8a', family: 'Inter,sans-serif' }}, standoff: 20 }},
    showgrid: true, gridcolor: '#e8ecf4', gridwidth: 1,
    color: '#374151',
    tickfont: {{ size: 11, color: '#374151', family: 'Inter,sans-serif' }},
  ...
  hoverlabel: {{
    ...
    font: {{ size: 11, family: 'Inter,sans-serif', color: '#1e3a8a' }},
    namelength: 0
  }},
